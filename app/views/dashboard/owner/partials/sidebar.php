<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main" style="z-index: 1021;">
  <div class="sidenav-header">
    <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
    <a class="navbar-brand m-0" href="./dashboard/home/">
      <img src="./app/assets/dashboard/img/logo-ct.png" class="navbar-brand-img h-100" alt="main_logo" />
      <span class="ms-1 font-weight-bold"><?php echo (isset($response->data->store->name) === true) ? $response->data->store->name : 'Your Store'; ?></span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse w-auto h-auto h-100 ps" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <!-- Dashboard -->
      <!-- <li class="nav-item">
        <a class="nav-link <?php echo (isset($section) === true and isset($subSection) === true and $section == 'HOME') ? 'active' : null; ?>" href="./dashboard/" target="_self">
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo (isset($section) === true and isset($subSection) === true and $section == 'SALE') ? 'active' : null; ?>" href="./dashboard/sale/" target="_self">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center me-2">
            <i class="ni ni-cart text-lg opacity-10 text-dark link-icon-active" aria-hidden="true"></i>
          </div>
          <span class="nav-link-text ms-1">Sale</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php echo (isset($section) === true and isset($subSection) === true and $section == 'PURCHASE') ? 'active' : null; ?>" href="./dashboard/purchase/" target="_self">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center me-2">
      ...
      <!-- Invoices -->
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#dropInvoices" class="nav-link <?php echo (isset($section) === true and $section == 'INVOICES') ? 'active' : null; ?>" aria-controls="dropInvoices" role="button" aria-expanded="false">
          <div class="
        ...
        <div class="collapse <?php echo (isset($section) === true and $section == 'INVOICES') ? 'show' : null; ?>" id="dropInvoices">
          <ul class="nav ms-4 ps-3">
            <li class="nav-item">
              <a class="nav-link <?php echo (isset($section) === true and isset($subSection) === true and $section == 'INVOICES' and $subSection == 'PURCHASES') ? 'active' : null; ?>" href="./dashboard/invoice/purchases/">
                <span class="sidenav-mini-icon"> P </span>
                <span class="sidenav-normal"> Purchases </span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php echo (isset($section) === true and isset($subSection) === true and $section == 'INVOICES' and $subSection == 'SALES') ? 'active' : null; ?>" href="./dashboard/invoice/sales/">
      ...
      <!-- Dues -->
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#menuDues" class="nav-link <?php echo (isset($section) === true and $section == 'DUES') ? 'active' : null; ?>" aria-controls="menuDues" role="button" aria-expanded="false">
          <div class="
              icon icon-shape icon-sm
              shadow
              border-radius-md
          ...
          <span class="nav-link-text ms-1">Dues / Credits</span>
        </a>
        <div class="collapse <?php echo (isset($section) === true and $section == 'DUES') ? 'show' : null; ?>" id="menuDues">
          <ul class="nav ms-4 ps-3">
            <li class="nav-item">
              <a class="nav-link <?php echo (isset($section) === true and isset($subSection) === true and $section == 'DUES' and $subSection == 'SALES') ? 'active' : null; ?>" href="./dashboard/dues/sales/pending">
                <span class="sidenav-mini-icon"> S </span>
                <span class="sidenav-normal">
                  Sales Dues <b class="caret"></b></span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php echo (isset($section) === true and isset($subSection) === true and $section == 'DUES' and $subSection == 'BUYERS') ? 'active' : null; ?>" href="./dashboard/dues/buyers/pending">
                <span class="sidenav-mini-icon"> S </span>
                <span class="sidenav-normal">
                  Customer Dues <b class="caret"></b></span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <!-- In-Queue Orders -->
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#menuInQueueOrders" class="nav-link <?php echo (isset($section) === true and $section == 'In-QUEUE ORDERS') ? 'active' : null; ?>" aria-controls="menuInQueueOrders" role="button" aria-expanded="false">
          <div class="
              icon icon-shape icon-sm
              shadow
              border-radius-md
          ...
          <span class="nav-link-text ms-1">In-Queue Orders</span>
        </a>
        <div class="collapse <?php echo (isset($section) === true and $section == 'In-QUEUE ORDERS') ? 'show' : null; ?>" id="menuInQueueOrders">
          <ul class="nav ms-4 ps-3">
            <li class="nav-item <?php echo (isset($section) === true and isset($subSection) === true and $section == 'In-QUEUE ORDERS' and $subSection == 'NEW') ? 'active' : null; ?>">
              <a class="nav-link" href="./dashboard/orders-queue/new/">
                <span class="sidenav-mini-icon"> G </span>
                <span class="sidenav-normal">
                  New Order <b class="caret"></b></span>
              </a>
            </li>
            <li class="nav-item <?php echo (isset($section) === true and isset($subSection) === true and $section == 'In-QUEUE ORDERS' and $subSection == 'QUEUE') ? 'active' : null; ?>">
              <a class="nav-link" href="./dashboard/orders-queue/view/all">
                <span class="sidenav-mini-icon"> G </span>
                <span class="sidenav-normal">
                  Check Queue <b class="caret"></b></span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <!-- Expenses -->
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#menuExpenses" class="nav-link <?php echo (isset($section) === true and $section == 'EXPENSES') ? 'active' : null; ?>" aria-controls="menuExpenses" role="button" aria-expanded="false">
          <div class="
              icon icon-shape icon-sm
              shadow
              border-radius-md
        ...
        <div class="collapse <?php echo (isset($section) === true and $section == 'EXPENSES') ? 'show' : null; ?>" id="menuExpenses">
          <ul class="nav ms-4 ps-3">
            <li class="nav-item <?php echo (isset($section) === true and isset($subSection) === true and $section == 'EXPENSES' and $subSection == 'NEW') ? 'active' : null; ?>">
              <a class="nav-link" href="./dashboard/expense/new/">
                <span class="sidenav-mini-icon"> G </span>
                <span class="sidenav-normal">
                  New Expense <b class="caret"></b></span>
              </a>
            </li>
            <li class="nav-item <?php echo (isset($section) === true and isset($subSection) === true and $section == 'EXPENSES' and $subSection == 'VIEW') ? 'active' : null; ?>">
              <a class="nav-link" href="./dashboard/expense/view/all">
                <span class="sidenav-mini-icon"> G </span>
                <span class="sidenav-normal">
                  View Expenses <b class="caret"></b></span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <!-- Sale Counters -->
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#saleCounters" class="nav-link <?php echo (isset($section) === true and $section == 'SALE COUNTER') ? 'active' : null; ?>" aria-controls="saleCounters" role="button" aria-expanded="false">
          <div class="
              icon icon-shape icon-sm
              shadow
              border-radius-md
          ...
          <span class="nav-link-text ms-1">Sale Counters</span>
        </a>
        <div class="collapse <?php echo (isset($section) === true and $section == 'SALE COUNTER') ? 'show' : null; ?>" id="saleCounters">
          <ul class="nav ms-4 ps-3">
            <li class="nav-item <?php echo (isset($section) === true and isset($subSection) === true and $section == 'SALE COUNTER' and $subSection == 'ADD') ? 'active' : null; ?>">
              <a class="nav-link" href="./dashboard/sale-counter/add">
                <span class="sidenav-mini-icon"> G </span>
                <span class="sidenav-normal">
                  Add Counter <b class="caret"></b></span>
              </a>
            </li>
            <li class="nav-item <?php echo (isset($section) === true and isset($subSection) === true and $section == 'SALE COUNTER' and $subSection == 'VIEW') ? 'active' : null; ?>">
              <a class="nav-link" href="./dashboard/sale-counter/view/all">
                <span class="sidenav-mini-icon"> G </span>
                <span class="sidenav-normal">
                  View Counters <b class="caret"></b></span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <!-- Stakeholders -->
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#menuStakeholders" class="nav-link <?php echo (isset($section) === true and $section == 'STAKEHOLDERS') ? 'active' : null; ?>" aria-controls="menuStakeholders" role="button" aria-expanded="false">
          <div class="
              icon icon-shape icon-sm
              shadow
              border-radius-md
          ...
          <span class="nav-link-text ms-1">Stakeholders</span>
        </a>
        <div class="collapse <?php echo (isset($section) === true and $section == 'STAKEHOLDERS') ? 'show' : null; ?>" id="menuStakeholders">
          <ul class="nav ms-4 ps-3">
            <li class="nav-item <?php echo (isset($section) === true and isset($subSection) === true and $section == 'STAKEHOLDERS' and $subSection == 'CUSTOMERS') ? 'active' : null; ?>">
              <a class="nav-link" href="./dashboard/buyer/view/all">
                <span class="sidenav-mini-icon"> G </span>
                <span class="sidenav-normal">
                  Customers <b class="caret"></b></span>
              </a>
            </li>
            <li class="nav-item <?php echo (isset($section) === true and isset($subSection) === true and $section == 'STAKEHOLDERS' and $subSection == 'SUPPLIERS') ? 'active' : null; ?>">
              <a class="nav-link" href="./dashboard/supplier/view/all">
                <span class="sidenav-mini-icon"> G </span>
                <span class="sidenav-normal">
                  Suppliers <b class="caret"></b></span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <!-- Reports -->
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#ecommerceExamples" class="nav-link <?php echo (isset($section) === true and $section == 'REPORTS') ? 'active' : null; ?>" aria-controls="ecommerceExamples" role="button" aria-expanded="false">
          <div class="
              icon 
              icon-shape 
              icon-sm 
              ...
              me-2
            ">
            <i class="ni ni-money-coins text-lg opacity-10 <?php echo (isset($section) === true and $section == 'REPORTS') ? null : 'text-dark'; ?>" width="12px" height="12px" aria-hidden="true"></i>
          </div>
          <span class="nav-link-text ms-1">Reports</span>
        </a>
        <div class="collapse <?php echo (isset($section) === true and $section == 'REPORTS') ? 'show' : null; ?>" id="ecommerceExamples">
          <ul class="nav ms-4 ps-3">
            <li class="nav-item <?php echo (isset($section) === true and isset($subSection) === true and $section == 'REPORTS' and $subSection == 'PURCHASES') ? 'active' : null; ?>">
              <a class="nav-link" href="./dashboard/report/purchase/">
                <span class="sidenav-mini-icon"> P </span>
                <span class="sidenav-normal"> Purchases </span>
              </a>
            </li>
            <li class="nav-item <?php echo (isset($section) === true and isset($subSection) === true and $section == 'REPORTS' and $subSection == 'SALES') ? 'active' : null; ?>">
              <a class="nav-link" href="./dashboard/report/sale/">
                <span class="sidenav-mini-icon"> S </span>
                <span class="sidenav-normal"> Sales </span>
              </a>
            </li>
            <li class="nav-item <?php echo (isset($section) === true and isset($subSection) === true and $section == 'REPORTS' and $subSection == 'CUSTOM') ? 'active' : null; ?>">
              <a class="nav-link" href="./dashboard/report/custom/">
                <span class="sidenav-mini-icon"> C </span>
                <span class="sidenav-normal"> Custom <small>(Sales)</small> </span>
              </a>
            </li>
            <!-- <li class="nav-item <?php // echo (isset($section) === true and isset($subSection) === true and $section == 'REPORTS' and $subSection == 'PROFIT-LOSS') ? 'active' : null; 
                                      ?>">
              <a class="nav-link" href="./dashboard/report/profitLoss">
                <span class="sidenav-mini-icon"> P & L </span>
      ...
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#itemsMenu" class="nav-link <?php echo (isset($section) === true and $section == 'ITEMS') ? 'active' : null; ?>" aria-controls="itemsMenu" role="button" aria-expanded="false">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center me-2">
        ...
        <div class="collapse <?php echo (isset($section) === true and $section == 'ITEMS') ? 'show' : null; ?>" id="itemsMenu">
          <ul class="nav ms-4 ps-3">
            <li class="nav-item <?php echo (isset($section) === true and isset($subSection) === true and $section == 'ITEMS' and $subSection == 'ADD') ? 'active' : null; ?>">
              <a class="nav-link" href="./dashboard/item/add/">
                <span class="sidenav-mini-icon"> A </span>
                <span class="sidenav-normal"> Add New </span>
              </a>
            </li>
            <li class="nav-item <?php echo (isset($section) === true and isset($subSection) === true and $section == 'ITEMS' and $subSection == 'VIEW') ? 'active' : null; ?>">
              <a class="nav-link" href="./dashboard/item/view/all/">
      ...
      <!-- Stock -->
      <!-- <li class="nav-item">
        <a data-bs-toggle="collapse" href="#menuStock" class="nav-link" aria-controls="menuStock" role="button" aria-expanded="false">
          <div class="
              icon icon-shape icon-sm
              shadow
              border-radius-md
              ...
              me-2
            ">
            <i class="ni ni-money-coins text-lg opacity-10 text-dark" width="12px" height="12px" aria-hidden="true"></i>
          </div>
      ...
      <!-- App Settings -->
      <!-- <li class="nav-item">
        <a data-bs-toggle="collapse" href="#menuAppSettings" class="nav-link" aria-controls="menuAppSettings" role="button" aria-expanded="false">
          <div class="
              icon icon-shape icon-sm
              shadow
              border-radius-md
          ...
          <span class="nav-link-text ms-1">App Settings</span>
        </a>
        <div class="collapse" id="menuAppSettings">
          <ul class="nav ms-4 ps-3">
            <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="./account/logout" target="_blank">
          <div class="
              icon icon-shape icon-sm
              shadow
              border-radius-md
  ...
  <!-- <div class="sidenav-footer mx-3">
    <div class="
      ...
      <div class="full-background" style="
          background-image: url('./app/assets/dashboard/img/curved-images/white-curved.jpeg');
        "></div>
